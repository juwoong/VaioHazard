 ...
 * @author Nathan Sweet */
public class RightCheckBox extends TextButton {
    private Image image;
    private Cell imageCell;
    private CheckBoxStyle style;

    public RightCheckBox(String text, Skin skin) {
        this(text, skin.get(CheckBoxStyle.class));
    }

    public RightCheckBox(String text, Skin skin, String styleName) {
        this(text, skin.get(styleName, CheckBoxStyle.class));
    }

    public RightCheckBox(String text, CheckBoxStyle style) {
        super(text, style);
        clearChildren();
    ...
    /** The style for a select box, see {@link RightCheckBox}.
     * @author Nathan Sweet */
